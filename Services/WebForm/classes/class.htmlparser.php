...
class HtmlParser {
	...
	// fim: [webform] added variables for node start and node length
	/**
     * Field iNodeStart.
     ...
     */
    function parse() {
    	// fim: [webform] set the node start
        ...
        $ret = $this->readTag();
		//fim: [webform] set the node length
        $this->iNodeLength = $this->iHtmlTextIndex - $this->iNodeStart;
        return $ret;
        // fim.
    }
