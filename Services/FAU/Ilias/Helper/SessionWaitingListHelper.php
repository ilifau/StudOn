...
/**
 * trait for providing additional ilSessionWaitingList methods
 */
trait SessionWaitingListHelper 
{
    // fau: fairSub#84 - add subject, to_confirm and sub_time as parameter, avoid re-reading
    /**
     * add to list
     *
     * @param 	int 		$a_usr_id
