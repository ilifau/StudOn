...
class iljQueryUtil
{
     ...
     */
    public static function initLightbox2()
    {
        ...
        $tpl->addJavaScript("./Customizing/libs/lightbox2/js/lightbox.min.js", true, 1);
        $tpl->addCss("./Customizing/libs/lightbox2/css/lightbox.css");
    }
    // fau.
}
