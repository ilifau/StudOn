...
class ilTemplate extends HTML_Template_ITX
{
    ...
    */
    ...
    public $custom_css_files = array();	// these will be included after the basic css file
    public $custom_meta_tags = array();	// these will be included after the basic meta tags
// fau.
