...
class ilUnivisImportLecturesTableGUI extends ilTable2GUI
{
	...
	* @param    integer     id
    */
	function setParentObjId($a_obj_id)
	{
    ...
    */
	function setSelectedIds($a_ids = array())
	{
    ...
    */
	function getOwnerLink($a_obj_id)
	{
