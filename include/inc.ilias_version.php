...
* @package ilias-core
*/
define("ILIAS_VERSION", "5.4.19 2020-12-11");
define("ILIAS_VERSION_NUMERIC", "5.4.19");			// must be always x.y.z: x, y and z are numbers
...
define("ILIAS_VERSION_SUFFIX", ILIAS_VERSION_NUMERIC . ".39");
// fau.
