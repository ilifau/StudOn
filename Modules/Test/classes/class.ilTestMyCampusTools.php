...
class ilTestMyCampusTools
{
	 ...
	 * @param 	string	value
	 */
	function setOption($a_key, $a_value)
	{
	 ...
	 */
	function checkRegistrationsFile($a_file)
	{
		global $lng;
	 ...
	 */
	function writeExportFileCVS($a_header = array(), $a_rows = array())
	{
