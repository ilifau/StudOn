    ...
    */
    public function &executeCommand()
    {
        ...
        if (!ilCust::extendedUserDataAccess()) {
            ilUtil::sendInfo(sprintf($lng->txt("ass_campo_export_forbidden"), "goto.php?target=studon_exportrequest"), true);
...
*/
    ...
    public function submitExportForm()
    {
        ...
        ilUtil::sendSuccess($lng->txt("ass_campo_file_written"), true);
        $ilCtrl->redirectByClass('iltestexportgui');
    }
