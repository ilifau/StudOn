...
class ilExAssTypeTestResultAssignment extends ActiveRecord
{
     ...
     * @return self
     */
    public static function findOrGetInstance($primary_key, array $add_constructor_args = array()): ilExAssTypeTestResultAssignment
    {
        /** @var self $record */
     ...
     */
    public function setTestRefId( $test_ref_id): void
    {
     ...
     */
    public function storeResult(ilObjTest $test, ilTestSession $session): mixed
    {
        global $DIC;
        $lng = $DIC->language();
     ...
     */
    public static function updateAssignments(ilObjTest $test, ilTestSession $session): void
    {
        global $DIC;
        $db = $DIC->database();
     ...
     * @param null $pass
     */
    protected function getPassNumber($pass = null): int|string
    {
