<?php
// fau: exAssTest - new class ilExAssTypeTestResultSelectionExplorerGUI.

/**
 * Class ilExAssTypeTestResultSelectionExplorerGUI
 */
class ilExAssTypeTestResultSelectionExplorerGUI extends ilRepositoryExplorerGUI
{
    /**
