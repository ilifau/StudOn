...
class ilObjRole extends ilObject
{
    ...
    public function read(): void
    {
        ...
        if ($res->numRows() > 0) {
            ...
            $this->toggleAssignUsersStatus((bool) ($row['assign_users'] ?? false));
        } else {
    ...
    public function __getPermissionDefinitions(): array
    {
        ...
        foreach ($operation_info as $info) {
            ...
            $rbac_objects[$info['typ_id']] = ["obj_id" => $info['typ_id'],
                                                   "type" => $info['type']
            ];
            ...
            $rbac_operations[$info['typ_id']][$info['ops_id']] = [
                "ops_id" => $info['ops_id'],
