...
function entry_point(string $name): int
{
    ...
    $seek = new Pimple\Container();
    $seek[ILIAS\Component\Tests\Dependencies\Scenario4\Contribution::class] = fn() => [
        $contribute[0][ILIAS\Component\Tests\Dependencies\Scenario4\Contribution::class . "_0"],
        $contribute[1][ILIAS\Component\Tests\Dependencies\Scenario4\Contribution::class . "_0"],
        $contribute[1][ILIAS\Component\Tests\Dependencies\Scenario4\Contribution::class . "_1"],
    ];
