 ...
 *
 *********************************************************************/
// fau: userData - class for educations field in user profile
...
class Educations implements FieldDefinition
{
    use NoOverrides;
    ...
    public function retrieveValueFromUser(?\ilObjUser $user): string
    {
        ...
        if ($user) {
            return nl2br($DIC->fau()->user()->getEducationsAsText($user->getId()));
        }
        else return "";
    }
}
