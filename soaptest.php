 ...
 */
$ilias_base_url = "http://localhost/studon7"; 	// this your base ILIAS url, you should use https in productive environments
$ilias_client = "myilias";					// the client ID (see ILIAS setup) of your ILIAS client
$ilias_soap_username = "root";					// the name of the soap user you created in the ILIAS administration
$ilias_soap_user_password = "StudOnDevUbuntu";			// password of the soap user
...
$wsdl = $ilias_base_url."/webservice/soap/server.php?wsdl=1"; // ILIAS url of soap wsdl
$client = new nusoap_client($wsdl, true/*, false, false, false, false, 300, 300*/);
//$client->setCredentials($ilias_soap_username, $ilias_soap_user_password, "basic");
	...
	"usr_xml" => '<?xml version="1.0" encoding="UTF-8"?>'.
		'<Users>'.
			'<User Id="tim.thaler" Language="de" Action="Insert">'.
 			...
 			'</User>'.
		'</Users>',
	"conflict_rule" => 3,						// ignore on conflict
